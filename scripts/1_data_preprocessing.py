"""
Data preprocessing: PDF text extraction, metadata loading, and chunking.

Outputs a JSONL file with one document per line:
{
    "doc_id": "Bancassurance Presentation",
    "source_pdf": "data/Bancassurance Presentation.pdf",
    "metadata": {...},          # from matching JSON sidecar
    "full_text": "...",         # cleaned text
    "chunks": [                 # chunked for retrieval
        {"id": "Bancassurance Presentation::0", "text": "...", "metadata": {...}},
        ...
    ]
}
